...
function summary_stats_non_overlapping(fName, s_pos, s_del, mu, N_muts_necessary, bx_size, weights_matrix, total_weight_sum, weights_matrix_bx, total_weight_sum_bx)
...
for j=1:length(mut_probs_tested)
    ...
    parfor i=1:N_runs % Parallel loop
        ...
        [shannon_indices, simpson_indices, moranI_time_series,  gearyC_time_series, fpi0, fpi, fpi2, fpi3,mpi_pos,mpi_tot, lattice_erpos_time_series, lattice_ki67_time_series,...
            ...
            new_model2d_non_overlapping_bx(N_muts_necessary,s_pos, s_del,mut_probs_tested(j), bx_size, times_vec,weights_matrix,total_weight_sum,weights_matrix_bx,total_weight_sum_bx);
